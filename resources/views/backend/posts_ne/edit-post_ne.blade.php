@extends('layouts.vertical', ['page_title' => 'Edit Nepali Post', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Edit Nepali Post</h4>
                    <form action="{{ route('backend.post_ne.update', $post->id) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-9">
                                {{-- main content --}}
