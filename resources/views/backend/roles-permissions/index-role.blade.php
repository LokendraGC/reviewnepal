            ...
            <div class="col-12">
                <div class="page-title-box py-3 d-flex justify-content-start align-content-center  gap-2">
                    <div class="align-self-center">
                        <h4 class="page-title" style="line-height: unset;">Roles</h4>
                    </div>
                    <div>
                        <a href="{{ route('backend.role.create') }}" class="btn btn-outline-primary">Add New Role</a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row-action">
                                                    <span class="add-edit-permission">
                                                        <a href="{{ route('addPermissionToRole', $role->id) }}"
                                                            class="text-primary">Add/Edit Permission</a>
                                                        |
                                                    </span>
                                                    <span class="edit">
