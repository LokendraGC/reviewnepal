        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="director_name" name="director_name"
                    value="{{ isset($settings['director_name']) ? $settings['director_name'] : '' }}" />
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="editor_name" name="editor_name"
                    value="{{ isset($settings['editor_name']) ? $settings['editor_name'] : '' }}" />
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
                <label for="director_name_nepali" class="form-label">Director Name in Nepali</label>
                <input type="text" class="form-control" id="director_name_nepali" name="director_name_nepali"
                    value="{{ isset($settings['director_name_nepali']) ? $settings['director_name_nepali'] : '' }}" />
            </div>

            <div class="mb-3">
                <label for="editor_name_nepali" class="form-label">Editor Name in Nepali</label>
                <input type="text" class="form-control" id="editor_name_nepali" name="editor_name_nepali"
                    value="{{ isset($settings['editor_name_nepali']) ? $settings['editor_name_nepali'] : '' }}" />
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="registration_number" name="registration_number"
                    value="{{ isset($settings['registration_number']) ? $settings['registration_number'] : '' }}" />
            </div>
        </div>

        <div class="col-md-6">
            <div class="mb-3">
                <label for="registration_number_nepali" class="form-label">Registration Number in Nepali</label>
                <input type="text" class="form-control" id="registration_number_nepali"
                    name="registration_number_nepali"
                    value="{{ isset($settings['registration_number_nepali']) ? $settings['registration_number_nepali'] : '' }}" />
            </div>
        </div>
    </div>
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" name="subscribe_text" id="subscribe_text"
        value="{{ isset($settings['subscribe_text']) ? $settings['subscribe_text'] : '' }}">
</div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <div class="preview-closer">
                        @if (isset($settings['footer_logo_nepali']) && ($media = MediaHelper::getModel()->where('id', $settings['footer_logo_nepali'])->first()))
