<div class="tab-pane fade {{ !request()->has('tab') || request()->query('tab') == 'header' ? 'active show' : '' }}"
    ...
    <div class="mb-1">
     ...
     <div class="mb-3">
                    <label for="header_logo_sticky" class="form-label">Header Logo Sticky</label>
                    <div class="input-group open-media-manager" data-bs-toggle="modal" data-bs-target="#exampleModal"
                        style="cursor: pointer;" data-field="header_logo_sticky" data-select="single">
                        <div class="input-group-prepend">
                            <div class="input-group-text bg-soft-secondary font-weight-medium">
                                Browse
                            </div>
                    ...
                    <div class="preview-closer">
                        @if (isset($settings['header_logo_sticky']) &&
                                ($media = MediaHelper::getModel()->where('id', $settings['header_logo_sticky'])->first()))
                            <input type="hidden" id="header_logo_sticky" name="header_logo_sticky" class="selected-files"
                                value="{{ $settings['header_logo_sticky'] }}">
                            <div id="header_logo_sticky_select">
                                <div class="file-preview box sm">
                        ...
                        @else
                            <input type="hidden" id="header_logo_sticky" name="header_logo_sticky" class="selected-files"
                                value="" />
                            <div id="header_logo_sticky_select"></div>
                        @endif
                    </div>
                    <span class="form-text text-muted">
                        <small><i>(Recommended Image in SVG format)</i></small>
